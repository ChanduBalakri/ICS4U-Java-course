...
public class MyFirstMenu {
	...
	public static void main(String[] args) {
		...
		System.out.println("\u001B[34mThanks for using my menu!");
	}	
	...
	private static void displayMenu(){
		...
		System.out.println("\u001B[31mUsername Menu:\n1. Enter your Name\n2. Edit your name\n3. Display your Name\n4. Exit");
	...
	private static void enterName(){
		...
		System.out.println("\u001B[34mEnter your name:");
		...
		try {
			...
			System.out.println("\u001B[34mYou typed " + myName + "...there was a problem with that");
		}		
	...
	private static void editName(){
		...
		if (myName == null){
			System.out.println("\u001B[34mYou haven't entered your name yet! What is it?");
		}
		else {
			System.out.println("\u001B[34mYour name is " + myName + ", what should it be?");
		}
	...
	private static void readName(){
		...
		if (myName == null){
			...
			System.out.println("\u001B[34mSorry, I don't know your name.");
			enterName();
			
		}
		else {
			
			System.out.println("\u001B[34m"+myName);
